...
ACTIVOS = [
    ...
    {'ticker': 'White Sugar', 'tipo': 'commodity', 'nombre_investpy': 'London Sugar', 'pais': 'united kingdom'},
    {'ticker': 'US Sugar #11', 'tipo': 'commodity', 'nombre_investpy': 'US Sugar #11', 'pais': 'united states'},
    
    # MONEDAS
    {'ticker': 'USD/ARS', 'tipo': 'currency_cross', 'nombre_investpy': 'USD/ARS', 'pais': None},
    {'ticker': 'USD/BRL', 'tipo': 'currency_cross', 'nombre_investpy': 'USD/BRL', 'pais': None},
    {'ticker': 'US Dollar Index', 'tipo': 'index', 'nombre_investpy': 'US Dollar Index', 'pais': 'united states'},
    
    # PETRÓLEO
    {'ticker': 'Crude Oil WTI', 'tipo': 'commodity', 'nombre_investpy': 'Crude Oil WTI', 'pais': 'united states'},
    {'ticker': 'Brent Oil', 'tipo': 'commodity', 'nombre_investpy': 'Brent Oil', 'pais': 'united kingdom'},
...
def obtener_datos(activo, fecha_inicio):
    """Descarga datos de un solo activo usando investpy."""
    ...
    try:
        ...
        print(f"   ⚠️ Error descargando {activo['ticker']}: {e}")
        return None
